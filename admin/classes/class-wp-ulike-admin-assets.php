	...
	class wp_ulike_admin_assets {
		...
		public function load_notices_script() {
			wp_enqueue_script(
				...
				WP_ULIKE_ADMIN_URL . '/assets/js/notices.js',
				array(),
				WP_ULIKE_VERSION,
				true
			);
...
@media (prefers-color-scheme: dark) {
  ...
  .wp-ulike-about-card__title {
    color: #f0f0f1;
  }
  .wp-ulike-about__lead,
  .wp-ulike-about-summary,
  .wp-ulike-about-status__label,
  .wp-ulike-about-status__value,
  .wp-ulike-about-status__hint,
  .wp-ulike-about-meta dt,
  .wp-ulike-about-meta dd,
  .wp-ulike-about-backup__intro {
    color: #dcdcde;
  }
  .wp-ulike-about__badge {
    background: #3c434a;
    color: #f0f0f1;
  }
  .wp-ulike-about-status__item {
    border-color: #3c434a;
  }
  .wp-ulike-about-card--details summary {
    color: #f0f0f1;
  }
  .wp-ulike-about-card--muted {
    background: #32383e;
  }
  .notice {
    background: #32383e;
...
body.flavor-dark .wp-ulike-about,
body.flavor-dark .wp-ulike-about-card,
body.dark-mode .wp-ulike-about,
body.dark-mode .wp-ulike-about-card,
html[data-darkreader-mode] .wp-ulike-about,
html[data-darkreader-mode] .wp-ulike-about-card {
  color: #f0f0f1;
  background: #2c3338;
  border-color: #3c434a;
}
body.flavor-dark .wp-ulike-about-card__title,
body.dark-mode .wp-ulike-about-card__title,
html[data-darkreader-mode] .wp-ulike-about-card__title {
  color: #f0f0f1;
}
body.flavor-dark .wp-ulike-about__lead,
body.flavor-dark .wp-ulike-about-summary,
body.flavor-dark .wp-ulike-about-meta dt,
body.flavor-dark .wp-ulike-about-meta dd,
body.dark-mode .wp-ulike-about__lead,
body.dark-mode .wp-ulike-about-summary,
body.dark-mode .wp-ulike-about-meta dt,
body.dark-mode .wp-ulike-about-meta dd,
html[data-darkreader-mode] .wp-ulike-about__lead,
html[data-darkreader-mode] .wp-ulike-about-summary,
html[data-darkreader-mode] .wp-ulike-about-meta dt,
html[data-darkreader-mode] .wp-ulike-about-meta dd {
  color: #dcdcde;
}
';
			wp_add_inline_style( 'wp-ulike-admin', $dark_css );
		...
		$stats_inline = '
html:has(.ulike-stats-app){overflow:auto!important}
body:has(.ulike-stats-app){overflow:auto!important}
body:has(.ulike-stats-app) #wpcontent{overflow:visible!important}
body.dark-mode .ulike-stats-app,
body.flavor-dark .ulike-stats-app,
html[data-darkreader-mode] .ulike-stats-app {
  --ulike-stats-color-text: #f6f7f7;
  --ulike-stats-color-text-secondary: #dcdcde;
  --ulike-stats-color-text-muted: #c3c4c7;
  --ulike-stats-color-bg: #2d333b;
  --ulike-stats-color-bg-secondary: #32383f;
  --ulike-stats-color-bg-canvas: #24292f;
  --ulike-stats-color-bg-hover: #424a54;
  --ulike-stats-color-bg-active: #424a54;
  --ulike-stats-color-border: #4b535e;
  --ulike-stats-color-header-bg: #2d333b;
}
';
		wp_add_inline_style( 'wp_ulike_admin_react', $stats_inline );
