...
if ( ! class_exists( 'wp_ulike_admin_pages' ) ) {
	...
	class wp_ulike_admin_pages {
		...
		private function register_parent_menu() {
			...
			$page_title = apply_filters( 'wp_ulike_plugin_name', esc_html__( 'Flavor Like', 'wp-ulike' ) );
			$menu_title = apply_filters( 'wp_ulike_plugin_name', esc_html__( 'Flavor Like', 'wp-ulike' ) );
		...
		private function register_settings_submenu( $parent_hook ) {
			...
			$settings_submenu_hook = add_submenu_page(
				'wp-ulike-settings',
				esc_html__( 'Flavor Like Settings', 'wp-ulike' ),
