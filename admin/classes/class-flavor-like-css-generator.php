...
if ( ! class_exists( 'flavor_like_css_generator' ) ) {
    class flavor_like_css_generator {
         ...
         */
        protected $css_cache_option = 'flavor_like_customizer_css_cache';

        /**
         * Option name for values hash (to detect changes)
         */
        protected $values_hash_option = 'flavor_like_customizer_values_hash';
        ...
        protected function get_schema() {
            ...
            try {
                ...
                if ( defined( 'WP_DEBUG' ) && WP_DEBUG ) {
                    error_log( 'Flavor Like CSS Generator: Failed to get schema - ' . $e->getMessage() );
                }
                return array();
            }
        }
        ...
        protected function sanitize_css_property( $property ) {
             ...
             */
            $valid_properties = apply_filters( 'flavor_like_css_valid_properties', $base_properties );
        ...
        protected function set_cached_css( $css, $hash ) {
            ...
            if ( function_exists( 'wp_cache_set' ) ) {
                wp_cache_set( $this->css_cache_option, $css, 'flavor_like_customizer', 0 );
                wp_cache_set( $this->values_hash_option, $hash, 'flavor_like_customizer', 0 );
            }
        }
        ...
        public function clear_cache( $new_values = null ) {
            ...
            if ( function_exists( 'wp_cache_delete' ) ) {
                wp_cache_delete( $this->css_cache_option, 'flavor_like_customizer' );
                wp_cache_delete( $this->values_hash_option, 'flavor_like_customizer' );
            }
        }
    }
}
