...
if ( ! class_exists( 'Flavor_Like_Stats_Meta' ) ) {
	/**
	 * Builds bootstrap meta consumed by flavor_like_stats_api.
	 */
	final class Flavor_Like_Stats_Meta {
		...
		private static function type_requires_login( $type ) {
			...
			return flavor_like_setting_repo::requireLogin( $setting_type );
		}
	}
}
