...
function wp_ulike_localization_api(){
	...
	wp_send_json( array(
		...
		'Publishing schedule and category performance' => esc_html__( 'Publishing schedule and category performance', 'wp-ulike' ),
		'Connect product engagement with sales to spot opportunities and plan campaigns' => esc_html__( 'Connect product engagement with sales to spot opportunities and plan campaigns', 'wp-ulike' ),
		...
		'{{total}} total 路 {{today}} today' => esc_html__( '{{total}} total 路 {{today}} today', 'wp-ulike' ),

		// Engagement reports
		'Trends'              => esc_html__( 'Trends', 'wp-ulike' ),
		'Top content'         => esc_html__( 'Top content', 'wp-ulike' ),
		'positive'            => esc_html__( 'positive', 'wp-ulike' ),
		'Vote history 路 {{type}}' => esc_html__( 'Vote history 路 {{type}}', 'wp-ulike' ),
		'Only {{ratio}}% positive this week 鈥?check Top content for items getting dislikes.' => esc_html__( 'Only {{ratio}}% positive this week 鈥?check Top content for items getting dislikes.', 'wp-ulike' ),
		...
		'{{likes}} likes this week 鈥?use Top content to find what resonates.' => esc_html__( '{{likes}} likes this week 鈥?use Top content to find what resonates.', 'wp-ulike' ),
		'{{likes}} likes and {{dislikes}} dislikes 鈥?use Top content to find what resonates.' => esc_html__( '{{likes}} likes and {{dislikes}} dislikes 鈥?use Top content to find what resonates.', 'wp-ulike' ),
		...
		'{{count}} actions this week 鈥?reward top engagers to build loyalty.' => esc_html__( '{{count}} actions this week 鈥?reward top engagers to build loyalty.', 'wp-ulike' ),
		'{{count}} actions this week 鈥?reward top members to build loyalty.' => esc_html__( '{{count}} actions this week 鈥?reward top members to build loyalty.', 'wp-ulike' ),
		'{{count}} actions this week 鈥?see which visitors engage most often.' => esc_html__( '{{count}} actions this week 鈥?see which visitors engage most often.', 'wp-ulike' ),
		...
		'Last {{count}} days'    => esc_html__( 'Last {{count}} days', 'wp-ulike' ),
		'Last {{count}} months'  => esc_html__( 'Last {{count}} months', 'wp-ulike' ),
		'This month'             => esc_html__( 'This month', 'wp-ulike' ),
		'Last month'             => esc_html__( 'Last month', 'wp-ulike' ),
		'Quarter to date'        => esc_html__( 'Quarter to date', 'wp-ulike' ),
		'This year'              => esc_html__( 'This year', 'wp-ulike' ),
		'Last calendar year'     => esc_html__( 'Last calendar year', 'wp-ulike' ),

		// Tables & lists
		'Content'         => esc_html__( 'Content', 'wp-ulike' ),
		'Performance'     => esc_html__( 'Performance', 'wp-ulike' ),
		'Published'       => esc_html__( 'Published', 'wp-ulike' ),
		'Views'           => esc_html__( 'Views', 'wp-ulike' ),
		'Dislikes'        => esc_html__( 'Dislikes', 'wp-ulike' ),
		...
		'{{likes}} likes 路 {{dislikes}} dislikes' => esc_html__( '{{likes}} likes 路 {{dislikes}} dislikes', 'wp-ulike' ),
		'All likes in this period.' => esc_html__( 'All likes in this period.', 'wp-ulike' ),
		'Daily counts for this period.' => esc_html__( 'Daily counts for this period.', 'wp-ulike' ),
		'Enable it in General settings to see engagement rate and button impressions.' => esc_html__( 'Enable it in General settings to see engagement rate and button impressions.', 'wp-ulike' ),
		'Enable view tracking in General settings if you have not already to see engagement rate and button impressions.' => esc_html__( 'Enable view tracking in General settings if you have not already to see engagement rate and button impressions.', 'wp-ulike' ),
		'Engagement as a share of page views.' => esc_html__( 'Engagement as a share of page views.', 'wp-ulike' ),
		'Impressions will appear as visitors view pages with your like button.' => esc_html__( 'Impressions will appear as visitors view pages with your like button.', 'wp-ulike' ),
		'How page views convert to engagement.' => esc_html__( 'How page views convert to engagement.', 'wp-ulike' ),
		'No button impressions in this period yet.' => esc_html__( 'No button impressions in this period yet.', 'wp-ulike' ),
		'Likes as a share of all reactions.' => esc_html__( 'Likes as a share of all reactions.', 'wp-ulike' ),
		'{{likes}} of {{total}} reactions' => esc_html__( '{{likes}} of {{total}} reactions', 'wp-ulike' ),
		'Change compared to the previous period.' => esc_html__( 'Change compared to the previous period.', 'wp-ulike' ),
		'{{rate}}% engagement rate' => esc_html__( '{{rate}}% engagement rate', 'wp-ulike' ),
		...
		'Reaction and voter metrics.' => esc_html__( 'Reaction and voter metrics.', 'wp-ulike' ),
		'View tracking is off.' => esc_html__( 'View tracking is off.', 'wp-ulike' ),
		...
		'{{day}} 路 {{time}}'  => esc_html__( '{{day}} 路 {{time}}', 'wp-ulike' ),
		'{{share}}% of weekly activity' => esc_html__( '{{share}}% of weekly activity', 'wp-ulike' ),
		'{{share}}% of all activity 路 {{range}}' => esc_html__( '{{share}}% of all activity 路 {{range}}', 'wp-ulike' ),
		...
		'Best day(s)'         => esc_html__( 'Best day(s)', 'wp-ulike' ),
		'Share of weekly activity' => esc_html__( 'Share of weekly activity', 'wp-ulike' ),
		...
		'{{share}}% of engagers use mobile 鈥?optimize for small screens.' => esc_html__( '{{share}}% of engagers use mobile 鈥?optimize for small screens.', 'wp-ulike' ),
		'{{share}}% engage from desktop 鈥?long-form content may perform better.' => esc_html__( '{{share}}% engage from desktop 鈥?long-form content may perform better.', 'wp-ulike' ),

		// WooCommerce intelligence report
		'WooCommerce' => esc_html__( 'WooCommerce', 'wp-ulike' ),
		'WooCommerce report unavailable' => esc_html__( 'WooCommerce report unavailable', 'wp-ulike' ),
		'Enable likes on products or reviews, or wait for store orders, to unlock commerce intelligence.' => esc_html__( 'Enable likes on products or reviews, or wait for store orders, to unlock commerce intelligence.', 'wp-ulike' ),
		'Store snapshot' => esc_html__( 'Store snapshot', 'wp-ulike' ),
		'Engagement correlated with sales' => esc_html__( 'Engagement correlated with sales', 'wp-ulike' ),
		'Unique view: see whether shopper reactions align with orders and revenue.' => esc_html__( 'Unique view: see whether shopper reactions align with orders and revenue.', 'wp-ulike' ),
		'Product likes' => esc_html__( 'Product likes', 'wp-ulike' ),
		'Likes and dislikes on WooCommerce products.' => esc_html__( 'Likes and dislikes on WooCommerce products.', 'wp-ulike' ),
		'Product engagement' => esc_html__( 'Product engagement', 'wp-ulike' ),
		'Reactions on verified customer product reviews.' => esc_html__( 'Reactions on verified customer product reviews.', 'wp-ulike' ),
		'Review engagement' => esc_html__( 'Review engagement', 'wp-ulike' ),
		'Completed and processing orders.' => esc_html__( 'Completed and processing orders.', 'wp-ulike' ),
		'Orders' => esc_html__( 'Orders', 'wp-ulike' ),
		'Net product revenue in this period.' => esc_html__( 'Net product revenue in this period.', 'wp-ulike' ),
		'Revenue' => esc_html__( 'Revenue', 'wp-ulike' ),
		'Product units sold in this period.' => esc_html__( 'Product units sold in this period.', 'wp-ulike' ),
		'Units sold' => esc_html__( 'Units sold', 'wp-ulike' ),
		'Average revenue per order in this period.' => esc_html__( 'Average revenue per order in this period.', 'wp-ulike' ),
		'Average order value' => esc_html__( 'Average order value', 'wp-ulike' ),
		'Average product and review reactions per order 鈥?a pre-purchase interest signal.' => esc_html__( 'Average product and review reactions per order 鈥?a pre-purchase interest signal.', 'wp-ulike' ),
		'Engagement per order' => esc_html__( 'Engagement per order', 'wp-ulike' ),
		'Revenue generated per like or dislike 鈥?helps compare campaign ROI.' => esc_html__( 'Revenue generated per like or dislike 鈥?helps compare campaign ROI.', 'wp-ulike' ),
		'Revenue per engagement' => esc_html__( 'Revenue per engagement', 'wp-ulike' ),
		'Engagement vs orders trend' => esc_html__( 'Engagement vs orders trend', 'wp-ulike' ),
		'Daily product reactions compared with store orders' => esc_html__( 'Daily product reactions compared with store orders', 'wp-ulike' ),
		'Look for days when engagement rises before orders 鈥?a sign your social proof is working.' => esc_html__( 'Look for days when engagement rises before orders 鈥?a sign your social proof is working.', 'wp-ulike' ),
		'Top products' => esc_html__( 'Top products', 'wp-ulike' ),
		'Engagement and sales side by side' => esc_html__( 'Engagement and sales side by side', 'wp-ulike' ),
		'No product engagement yet' => esc_html__( 'No product engagement yet', 'wp-ulike' ),
		'Product' => esc_html__( 'Product', 'wp-ulike' ),
		'Match score' => esc_html__( 'Match score', 'wp-ulike' ),
		'Opportunities' => esc_html__( 'Opportunities', 'wp-ulike' ),
		'Where engagement and sales diverge' => esc_html__( 'Where engagement and sales diverge', 'wp-ulike' ),
		'High interest, lower sales 鈥?optimize merchandising, pricing, or checkout.' => esc_html__( 'High interest, lower sales 鈥?optimize merchandising, pricing, or checkout.', 'wp-ulike' ),
		'Strong sellers with few likes 鈥?surface social proof with like buttons or badges.' => esc_html__( 'Strong sellers with few likes 鈥?surface social proof with like buttons or badges.', 'wp-ulike' ),
		'Engagement and revenue by product category' => esc_html__( 'Engagement and revenue by product category', 'wp-ulike' ),
		'Engagement vs sales intelligence' => esc_html__( 'Engagement vs sales intelligence', 'wp-ulike' ),
		'See how product likes and review reactions relate to orders and revenue 鈥?available in Pro.' => esc_html__( 'See how product likes and review reactions relate to orders and revenue 鈥?available in Pro.', 'wp-ulike' ),
		...
		'{{day}} around {{time}} gets the most engagement 鈥?schedule content then.' => esc_html__( '{{day}} around {{time}} gets the most engagement 鈥?schedule content then.', 'wp-ulike' ),
		'{{category}} drives {{share}}% of engagement 鈥?create more on this topic.' => esc_html__( '{{category}} drives {{share}}% of engagement 鈥?create more on this topic.', 'wp-ulike' ),
		'Low conversion' => esc_html__( 'Low conversion', 'wp-ulike' ),
		'Only {{rate}}% of viewers engage 鈥?improve button placement and CTAs.' => esc_html__( 'Only {{rate}}% of viewers engage 鈥?improve button placement and CTAs.', 'wp-ulike' ),
		'Momentum' => esc_html__( 'Momentum', 'wp-ulike' ),
		'Sentiment drop' => esc_html__( 'Sentiment drop', 'wp-ulike' ),
		'Positive reactions fell to {{ratio}}% 鈥?review content getting dislikes.' => esc_html__( 'Positive reactions fell to {{ratio}}% 鈥?review content getting dislikes.', 'wp-ulike' ),
		...
		'{{title}} converts best at {{rate}}% 鈥?replicate this format.' => esc_html__( '{{title}} converts best at {{rate}}% 鈥?replicate this format.', 'wp-ulike' ),
		'{{name}} is your most active user 鈥?consider a loyalty perk.' => esc_html__( '{{name}} is your most active user 鈥?consider a loyalty perk.', 'wp-ulike' ),
		...
		'{{count}} engagements so far 鈥?unlock audience maps, top fans, and publishing insights.' => esc_html__( '{{count}} engagements so far 鈥?unlock audience maps, top fans, and publishing insights.', 'wp-ulike' ),
		...
		'Minimized to 鈥淕et Pro鈥?in the sidebar.' => esc_html__( 'Minimized to 鈥淕et Pro鈥?in the sidebar.', 'wp-ulike' ),
		...
		'You have passed {{count}} total engagements 鈥?{{remaining}} to go until {{next}}.' => esc_html__( 'You have passed {{count}} total engagements 鈥?{{remaining}} to go until {{next}}.', 'wp-ulike' ),
		...
		'{{count}} engagements so far 鈥?{{remaining}} more to reach {{target}}.' => esc_html__( '{{count}} engagements so far 鈥?{{remaining}} more to reach {{target}}.', 'wp-ulike' ),
		'{{count}} engagements today 鈥?keep it going.' => esc_html__( '{{count}} engagements today 鈥?keep it going.', 'wp-ulike' ),
		'No engagements yet today 鈥?yesterday had {{count}}.' => esc_html__( 'No engagements yet today 鈥?yesterday had {{count}}.', 'wp-ulike' ),
		...
		'Around {{time}} gets the most engagement 鈥?schedule content then.' => esc_html__( 'Around {{time}} gets the most engagement 鈥?schedule content then.', 'wp-ulike' ),
		...
		'{{count}} dismissed announcement(s) stored for your account.' => esc_html__( '{{count}} dismissed announcement(s) stored for your account.', 'wp-ulike' ),
		...
		'Publishing schedule, category insights, and commerce analytics 鈥?available in Pro.' => esc_html__( 'Publishing schedule, category insights, and commerce analytics 鈥?available in Pro.', 'wp-ulike' ),
		'Publishing schedule and category insights 鈥?available in Pro.' => esc_html__( 'Publishing schedule and category insights 鈥?available in Pro.', 'wp-ulike' ),
		...
		'No engagers yet' => esc_html__( 'No engagers yet', 'wp-ulike' ),
		...
		'{{count}} emoji reactions this week 鈥?use Top content to find what resonates.' => esc_html__( '{{count}} emoji reactions this week 鈥?use Top content to find what resonates.', 'wp-ulike' ),
		'{{count}} star ratings this week 鈥?use Top content to find what resonates.' => esc_html__( '{{count}} star ratings this week 鈥?use Top content to find what resonates.', 'wp-ulike' ),
		'{{name}} is your top rater 鈥?consider a loyalty perk.' => esc_html__( '{{name}} is your top rater 鈥?consider a loyalty perk.', 'wp-ulike' ),
		'{{title}} averages 鈽?{{avg}} 鈥?replicate this format.' => esc_html__( '{{title}} averages 鈽?{{avg}} 鈥?replicate this format.', 'wp-ulike' ),
		'{{title}} leads with {{count}} reactions in this period.' => esc_html__( '{{title}} leads with {{count}} reactions in this period.', 'wp-ulike' ),
		'鈽?{{avg}} site average' => esc_html__( '鈽?{{avg}} site average', 'wp-ulike' ),
