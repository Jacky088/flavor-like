	...
	function wp_ulike_generate_templates_list(){
		...
		$default = array(
			'wpulike-default' => array(
				...
				'symbol'          => WP_ULIKE_ASSETS_URL . '/img/templates/simple.svg',
				'is_text_support' => true
			),
			'wpulike-heart' => array(
				'name'            => '简约爱心',
				'callback'        => 'wp_ulike_set_simple_heart_template',
				'symbol'          => WP_ULIKE_ASSETS_URL . '/img/templates/heart.svg',
				'is_text_support' => true
			),
			'wpulike-robeen' => array(
				'name'            => 'Twitter 爱心',
				'callback'        => 'wp_ulike_set_robeen_template',
				'symbol'          => WP_ULIKE_ASSETS_URL . '/img/templates/twitter.svg',
				'is_text_support' => false
			),
			'wpulike-animated-heart' => array(
				'name'            => '动态爱心',
				'callback'        => 'wp_ulike_set_animated_heart_template',
				'symbol'          => WP_ULIKE_ASSETS_URL . '/img/templates/animated-heart.svg',
				'is_text_support' => false
			),
			'wpulike-star-thumb' => array(
				'name'            => '星星拇指',
				'callback'        => 'wp_ulike_set_star_thumb_template',
				'symbol'          => WP_ULIKE_ASSETS_URL . '/img/templates/starThumb.svg',
				'is_text_support' => true
			),
			'wpulike-check-mark' => array(
				'name'            => '对勾标记',
				'callback'        => 'wp_ulike_set_check_mark_template',
				'symbol'          => WP_ULIKE_ASSETS_URL . '/img/templates/checkMark.svg',
				'is_text_support' => true
			),
			'wpulike-clapping' => array(
				'name'            => '鼓掌按钮',
				'callback'        => 'wp_ulike_set_clapping_template',
				'symbol'          => WP_ULIKE_ASSETS_URL . '/img/templates/clapping.svg',
				'is_text_support' => true
			),
			'wpulike-badge-thumb' => array(
				'name'            => '徽章拇指',
				'callback'        => 'wp_ulike_set_badge_thumb_template',
				'symbol'          => WP_ULIKE_ASSETS_URL . '/img/templates/badgeThumb.svg',
				'is_text_support' => true
			),
			'wpulike-fave-star' => array(
				'name'            => '收藏星',
				'callback'        => 'wp_ulike_set_fave_star_template',
				'symbol'          => WP_ULIKE_ASSETS_URL . '/img/templates/faveStar.svg',
				'is_text_support' => false
			),
			'wpulike-pin' => array(
				'name'            => '图钉按钮',
				'callback'        => 'wp_ulike_set_pin_template',
 ...
 * 星星拇指模板
 */
if( ! function_exists( 'wp_ulike_set_star_thumb_template' ) ){
	function wp_ulike_set_star_thumb_template( array $wp_ulike_template ){
		ob_start();
		do_action( 'wp_ulike_before_template', $wp_ulike_template );
		extract( $wp_ulike_template );
	?>
		<div class="wpulike wpulike-star-thumb <?php echo $wrapper_class; ?>" <?php echo $attributes; ?>>
			<div class="<?php echo $general_class; ?>">
				<button type="button"
					aria-label="<?php echo wp_ulike_setting_repo::getLikeAriaLabel(); ?>"
					data-ulike-id="<?php echo $ID; ?>"
		...
		<?php do_action( 'wp_ulike_inside_template', $wp_ulike_template ); ?>
		</div>
	<?php
		do_action( 'wp_ulike_after_template', $wp_ulike_template );
		return ob_get_clean();
 ...
 * 对勾标记模板
 */
if( ! function_exists( 'wp_ulike_set_check_mark_template' ) ){
	function wp_ulike_set_check_mark_template( array $wp_ulike_template ){
		ob_start();
		do_action( 'wp_ulike_before_template', $wp_ulike_template );
		extract( $wp_ulike_template );
	?>
		<div class="wpulike wpulike-check-mark <?php echo $wrapper_class; ?>" <?php echo $attributes; ?>>
			<div class="<?php echo $general_class; ?>">
				<button type="button"
					aria-label="<?php echo wp_ulike_setting_repo::getLikeAriaLabel(); ?>"
					data-ulike-id="<?php echo $ID; ?>"
 ...
 * 鼓掌按钮模板
 */
if( ! function_exists( 'wp_ulike_set_clapping_template' ) ){
	function wp_ulike_set_clapping_template( array $wp_ulike_template ){
		ob_start();
		do_action( 'wp_ulike_before_template', $wp_ulike_template );
		extract( $wp_ulike_template );
	?>
		<div class="wpulike wpulike-clapping <?php echo $wrapper_class; ?>" <?php echo $attributes; ?>>
			<div class="<?php echo $general_class; ?>">
				<button type="button"
					...
					class="<?php echo $button_class; ?>">
					<?php echo $up_vote_inner_text; ?>
					<span class="wpulike-clap-icon">👏</span>
					<?php
						do_action( 'wp_ulike_inside_like_button', $wp_ulike_template );
						if($button_type == 'text'){ echo '<span>' . $button_text . '</span>'; }
					?>
 ...
 * 徽章拇指模板
 */
if( ! function_exists( 'wp_ulike_set_badge_thumb_template' ) ){
	function wp_ulike_set_badge_thumb_template( array $wp_ulike_template ){
		ob_start();
		do_action( 'wp_ulike_before_template', $wp_ulike_template );
		extract( $wp_ulike_template );
	?>
		<div class="wpulike wpulike-badge-thumb <?php echo $wrapper_class; ?>" <?php echo $attributes; ?>>
			<div class="<?php echo $general_class; ?>">
				<button type="button"
					aria-label="<?php echo wp_ulike_setting_repo::getLikeAriaLabel(); ?>"
					data-ulike-id="<?php echo $ID; ?>"
 ...
 * 收藏星模板
 */
if( ! function_exists( 'wp_ulike_set_fave_star_template' ) ){
	function wp_ulike_set_fave_star_template( array $wp_ulike_template ){
		ob_start();
		do_action( 'wp_ulike_before_template', $wp_ulike_template );
		extract( $wp_ulike_template );
	?>
 ...
 * 图钉按钮模板
 */
if( ! function_exists( 'wp_ulike_set_pin_template' ) ){
	function wp_ulike_set_pin_template( array $wp_ulike_template ){
		ob_start();
		do_action( 'wp_ulike_before_template', $wp_ulike_template );
		extract( $wp_ulike_template );
	?>
		<div class="wpulike wpulike-pin <?php echo $wrapper_class; ?>" <?php echo $attributes; ?>>
			<div class="<?php echo $general_class; ?>">
				<button type="button"
					aria-label="<?php echo wp_ulike_setting_repo::getLikeAriaLabel(); ?>"
					data-ulike-id="<?php echo $ID; ?>"
