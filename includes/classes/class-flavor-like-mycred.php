<?php
/**
 * Flavor Like myCred support Class
 * // @echo HEADER
 */
...
if ( class_exists( 'myCRED_Hook' ) ) :
	...
	class flavor_like_myCRED extends myCRED_Hook {
		...
		public function run() {
			...
			add_action( 'flavor_like_after_process', array( $this, 'status' )	, 10, 4 );
		}
		...
		/**
		 * Preference for flavor_like Hook
		 *
		 * @since		2.3
		 */
...
<div class="hook-instance">
    <h3><?php esc_html_e( 'Points for liking content', 'flavor-like' ); ?></h3>
    <div class="row">
        <div class="col-lg-2 col-md-6 col-sm-6 col-xs-12">
            <div class="form-group">
                <label
                    for="<?php echo $this->field_id( array( 'add_like' => 'creds' ) ); ?>"><?php esc_html_e( 'Points', 'flavor-like' ); ?></label>
                ...
                <span class="description"><?php esc_html_e( 'Use zero to disable.', 'flavor-like' ); ?></span>
            </div>
        </div>
        <div class="col-lg-2 col-md-6 col-sm-12 col-xs-12">
            <div class="form-group">
                <label
                    for="<?php echo $this->field_id( array( 'add_like', 'limit' ) ); ?>"><?php esc_html_e( 'Limit', 'flavor-like' ); ?></label>
        ...
        <div class="col-lg-8 col-md-6 col-sm-12 col-xs-12">
            <div class="form-group">
                <label
                    for="<?php echo $this->field_id( array( 'add_like' => 'log' ) ); ?>"><?php esc_html_e( 'Log template', 'flavor-like' ); ?></label>
                <input type="text" name="<?php echo $this->field_name( array( 'add_like' => 'log' ) ); ?>"
                    id="<?php echo $this->field_id( array( 'add_like' => 'log' ) ); ?>"
                    placeholder="<?php esc_html_e( 'required', 'flavor-like' ); ?>"
...
<div class="hook-instance">
    <h3><?php esc_html_e( 'Points for Author Who Get Liked', 'flavor-like' ); ?></h3>
    <div class="row">
        <div class="col-lg-2 col-md-6 col-sm-6 col-xs-12">
            <div class="form-group">
                <label
                    for="<?php echo $this->field_id( array( 'get_like' => 'creds' ) ); ?>"><?php esc_html_e( 'Points', 'flavor-like' ); ?></label>
        ...
        <div class="col-lg-2 col-md-6 col-sm-12 col-xs-12">
            <div class="form-group">
                <label
                    for="<?php echo $this->field_id( array( 'get_like', 'limit' ) ); ?>"><?php esc_html_e( 'Limit', 'flavor-like' ); ?></label>
        ...
        <div class="col-lg-8 col-md-6 col-sm-12 col-xs-12">
            <div class="form-group">
                <label
                    for="<?php echo $this->field_id( array( 'get_like' => 'log' ) ); ?>"><?php esc_html_e( 'Log template', 'flavor-like' ); ?></label>
...
<div class="hook-instance">
    <h3><?php esc_html_e( 'Points for unliking content', 'flavor-like' ); ?></h3>
    <div class="row">
        <div class="col-lg-2 col-md-6 col-sm-6 col-xs-12">
            <div class="form-group">
                <label
                    for="<?php echo $this->field_id( array( 'add_unlike' => 'creds' ) ); ?>"><?php esc_html_e( 'Points', 'flavor-like' ); ?></label>
        ...
        <div class="col-lg-2 col-md-6 col-sm-12 col-xs-12">
            <div class="form-group">
                <label
                    for="<?php echo $this->field_id( array( 'add_unlike', 'limit' ) ); ?>"><?php esc_html_e( 'Limit', 'flavor-like' ); ?></label>
        ...
        <div class="col-lg-8 col-md-6 col-sm-12 col-xs-12">
            <div class="form-group">
                <label
                    for="<?php echo $this->field_id( array( 'add_unlike' => 'log' ) ); ?>"><?php esc_html_e( 'Log template', 'flavor-like' ); ?></label>
...
<div class="hook-instance">
    <h3><?php esc_html_e( 'Points for Author Who Get Unliked', 'flavor-like' ); ?></h3>
    <div class="row">
        <div class="col-lg-2 col-md-6 col-sm-6 col-xs-12">
            <div class="form-group">
                <label
                    for="<?php echo $this->field_id( array( 'get_unlike' => 'creds' ) ); ?>"><?php esc_html_e( 'Points', 'flavor-like' ); ?></label>
        ...
        <div class="col-lg-2 col-md-6 col-sm-12 col-xs-12">
            <div class="form-group">
                <label
                    for="<?php echo $this->field_id( array( 'get_unlike', 'limit' ) ); ?>"><?php esc_html_e( 'Limit', 'flavor-like' ); ?></label>
        ...
        <div class="col-lg-8 col-md-6 col-sm-12 col-xs-12">
            <div class="form-group">
                <label
                    for="<?php echo $this->field_id( array( 'get_unlike' => 'log' ) ); ?>"><?php esc_html_e( 'Log template', 'flavor-like' ); ?></label>
...
<div class="hook-instance">
    <h3><?php esc_html_e( 'Limits', 'flavor-like' ); ?></h3>
    <div class="row">
            ...
            <div class="form-group">
                <div class="checkbox">
                    <label for="<?php echo $this->field_id( array( 'limits' => 'self_reply' ) ); ?>"><input
                        ...
                        <?php echo $this->core->template_tags_general( esc_html__( '%plural% is to be awarded even when item authors Like/Unlike their own item.', 'flavor-like' ) ); ?></label>
                </div>
            </div>
        </div>
    </div>
