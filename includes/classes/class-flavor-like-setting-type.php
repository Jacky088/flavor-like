...
class flavor_like_setting_type {
	 ...
	 * 
	 * @param string $type
	 * @return flavor_like_setting_type
	 */
	...
	protected function setTypeSettings( $type ){
		$this->typeSettings = Flavor_Like_Pulse_Registry::setting_profile( $type );
	}
	...
	/**
	 * Legacy vote table suffix without prefix (flavor_like, flavor_like_comments, …).
	 *
	 * @return string|null
	 */
	...
	public function legacyTableExists() {
		...
		return $table && Flavor_Like_Pulse_Registry::table_exists( $table );
	}
